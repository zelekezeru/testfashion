          ...
          <nav class="navbar navbar-expand-lg navbar-light w-100">
            ...
            <a class="navbar-brand logo_h" href="index.html">
              <!-- <img src="img/logo.png" alt="" /> -->
               <h3>Ethiopipian Fashion Gallery</h3>
            </a>
            <button
              ...
              <div class="row">
                  ...
                  <div class="single-product">
                    ...
                    <div class="product-btm">
                      <a href="#" class="d-block">
                        <h4>Ocational Collections</h4>
                      </a>
                      <div class="mt-3">
                        <span class="mr-4">2,000.00 ETB</span>
                        <del>3,000.00 ETB</del>
                      </div>
                    </div>
                  </div>
                </div>
                ...
                <div class="col-lg-4 col-md-6">
                  <div class="single-product">
                    ...
                    <div class="product-btm">
                      <a href="#" class="d-block">
                        <h4>Cultural Collections</h4>
                      </a>
                      <div class="mt-3">
                        <span class="mr-4">2,500.00 ETB</span>
                        <del>3,400.00 ETB</del>
                      </div>
                    </div>
                  </div>
                </div>
                ...
                <div class="col-lg-4 col-md-6">
                  <div class="single-product">
                    ...
                    <div class="product-btm">
                      ...
                      <div class="mt-3">
                        <span class="mr-4">1,799.00 ETB</span>
                        <del>2,500.00 ETB</del>
                      </div>
                    </div>
                  </div>
                </div>
                ...
                <div class="col-lg-4 col-md-6">
                  <div class="single-product">
                    ...
                    <div class="product-btm">
                      <a href="#" class="d-block">
                        <h4>Latest Men’s Collections</h4>
                      </a>
                      <div class="mt-3">
              ...
              <aside class="left_widgets p_filter_widgets">
                ...
                <div class="widgets_inner">
                  <ul class="list">
                    ...
                    <li>
                      <a href="#">Type of Clothes</a>
                    </li>
                    <li>
                      <a href="#">Ocation</a>
                    </li>
                    <li>
                      <a href="#">Cloth Style</a>
                    </li>
                  </ul>
                </div>
              </aside>
